$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', '/maintain/resources/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', '/maintain/resources/css/bootstrap-' + themeName + '.min.css');
        }
...
function docReady() {
    ...
    $('#file_upload').uploadify({
        'swf': '/maintain/resources/misc/uploadify.swf',
        'uploader': '/maintain/resources/misc/uploadify.php'
